...
if __name__ == '__main__':
    ...
    if vid_list is None:
        print(args.flow_type)
        pool.map(
            extract_frame,
            zip(fullpath_list, len(fullpath_list)*[''], range(len(fullpath_list)),
                len(fullpath_list) * [args.flow_type],
                len(fullpath_list) * [args.task],
                len(fullpath_list) * [args.report_file]))
    else:
        pool.map(
            extract_frame,
